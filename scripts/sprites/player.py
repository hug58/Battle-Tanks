...
class Player(Cannon):
    ...
    def __init__(self,position, canno_type: CannonType):
        self.rect = pg.Rect(position,(30,30)) #get rect in img surface, value init is not used
        self.body_rect = pg.Rect(0,0,8*2,16*2)
        ...
        self._damage = 0
        self._num_player = 0
        Cannon.__init__(self,self.rect.center, canno_type)
    ...
    def rotate_external(self,xbool,angle,surface,rect):
